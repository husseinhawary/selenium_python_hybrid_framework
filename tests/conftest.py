...
def pytest_addoption(parser):
    parser.addoption(
        "--browser", action="store", default="chrome-headless",
        help="Send 'chrome' or 'firefox' or 'chrome-headless' as parameter for execution"
    )
...
def setup_and_teardown(request):
    ...
    # browser = Utils.read_configurations("basic_info", "browser")
    ...
    app_url = Utils.read_configurations("basic_info", "url")
    driver.get(app_url)
